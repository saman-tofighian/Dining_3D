  ...
  return (
    <div id="App">
      <div className="grid grid-cols-12 h-[100vh]">
        ...
        <div className="col-span-3 xl:col-span-2 py-8  gap-5" id="controller">
          <div className="w-full">
            <h5 className="text-[12px] xl:text-[16px] text-white ps-2">
              {data.title.t1}{" "}
            </h5>
            <div className="w-full flex justify-center mt-6 flex-wrap gap-y-5 gap-x-3">
              <button
          ...
          <div className="w-full mt-[2rem] xl:mt-[5rem] px-2 justify-center flex">
            <button className="py-3 px-2 xl:py-3 xl:px-7 rounded-2xl text-white bg-green-700 text-[12px] xl:text-[16px]">
              Add To Cart
            </button>
          </div>
        </div>
